...
describe("SignUp", () => {
  ...
  it("should set sesssion data for valid credentials and send correct json response", async () => {
    const req: Request = authMockRequest(
      {},
      {
        username: "Manny",
    ...
    jest.spyOn(cloudinaryUploads, "uploads").mockImplementation((): any => Promise.resolve({ version: "14651353", public_id: "46551551" }));
