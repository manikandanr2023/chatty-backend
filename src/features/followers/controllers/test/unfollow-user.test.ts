...
describe("Remove", () => {
  ...
  it("should send correct json response", async () => {
    ...
    jest.spyOn(FollowerCache.prototype, "removeFollowersFromCache");
    ...
    expect(FollowerCache.prototype.removeFollowersFromCache).toHaveBeenCalledTimes(2);
    expect(FollowerCache.prototype.removeFollowersFromCache).toHaveBeenCalledWith(
