...
export const postWithImageSchema: ObjectSchema = Joi.object().keys({
  image: Joi.string()
    .required()
    .messages({ "any.required": "Image is a required field", "string.empty": "Image property is not allowed to be empty" }),
  post: Joi.string().optional().allow(null, ""),
  video: Joi.string().optional().allow(null, ""),
  bgColor: Joi.string().optional().allow(null, ""),
  privacy: Joi.string().optional().allow(null, ""),
...
export const postWithVideoSchema: ObjectSchema = Joi.object().keys({
  video: Joi.string().required().messages({
    "any.required": "Video is requried",
