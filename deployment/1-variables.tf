...
variable "ec2_iam_policy_name" {
  ...
  type        = string
  default     = "chatapp-server-ec2-policy"
}
...
variable "nodejs" {
  ...
  type        = string
  default     = "ami-09d0267466ae7504e"
}


variable "custom_policy" {
  default     = "CustomPolicyForCodeDeploy"
  description = "Custom Policy For Code Deploy"
  type        = string
}
